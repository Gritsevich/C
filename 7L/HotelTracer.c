...
{	
  ...
  puts("To share feedback or get the source code, visit https://github.com/Gritsevich/C");
	puts("Contact mail: aaaaaaaaa@gmail.com");
	puts("--\nCopyright C 2020 by Gritsevich Rina. All rights reserved.");
	puts(delimetr);
